...
class LXRTXLayer(nn.Module):
    ...
    def cross_att(self, lang_input, lang_attention_mask, visn_input, visn_attention_mask):
        ...
        visn_att_output, attention_scores = self.visual_attention(visn_input, lang_input,
    ...
    def forward(self, lang_feats, lang_attention_mask,
        ...
        visn_att_output, cross_attention_scores = self.cross_att(lang_feats[:, 1:, :], lang_attention_mask[:, :, :, 1:],
                                                                 visn_att_output, state_vis_mask)
